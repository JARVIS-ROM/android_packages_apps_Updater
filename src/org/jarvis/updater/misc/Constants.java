 ...
 */
package org.jarvis.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.jarvis.build.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.jarvis.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.jarvis.releasetype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "jarvis.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "jarvis.updater.uri";
